...
var projectFiles = {
    ...
    'half_wide/index.inc':       'half_wide_index.inc.tmpl'
};
            ...
            default: {
                options: {
                    ...
                    data: {
                        ...
                        data: {
                            bmi:     grunt.file.readJSON('./source/data/processed/bmi.json'),
                            alcohol: grunt.file.readJSON('./source/data/processed/alcohol.json'),
                            years:   grunt.file.readJSON('./source/data/processed/years.json')
                        }
                    }
                },
                files: projectFiles
